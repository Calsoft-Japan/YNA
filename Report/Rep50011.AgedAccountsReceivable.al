report 50011 "AgedAccountsReceivable"
{
    // CS1.0  FDD204 Nick Bi. 2015-11-4. FDD204_Aged Accounts Receivable.
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/Aged Accounts Receivable.rdlc';

    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable - YNA';
        ...
        dataitem(Header; Integer)
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    begin
                        PrintDocumentNo := "Cust. Ledger Entry"."Document No.";
                        //Begin FDD204-M1. 2015-11-04. Nick.Bi
                        IF PrintDetail = TRUE THEN BEGIN
                            IF UseExternalDocNo = TRUE THEN BEGIN
                                //"Cust. Ledger Entry"."Document No." := "Cust. Ledger Entry"."External Document No.";
                                PrintDocumentNo := "Cust. Ledger Entry"."External Document No.";
                            END
                        END;
                        //End FDD204-M1
                ...
                dataitem(Totals; Integer)
                {
                    ...
                    column(Cust__Ledger_Entry___Document_No__; PrintDocumentNo)
                    {
                    }
    ...
    begin
        ...
        IF PrintDetail THEN BEGIN
            ...
            // Begin - Add "Ext. Doc. No." and "Original Amount" on 11/30/2021 by J.Wu
            ExcelBuf.AddColumn(FORMAT(Text122), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
            ExcelBuf.AddColumn("Cust. Ledger Entry".FIELDCAPTION("Original Amount"), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
            // End - Add "Ext. Doc. No." and "Original Amount" on 11/30/2021 by J.Wu
        END ELSE
    ...
    begin
        ...
        IF PrintDetail THEN BEGIN
            ...
            // Begin - Add "Ext. Doc. No." and "Original Amount" on 11/30/2021 by J.Wu
            ExcelBuf.AddColumn("Cust. Ledger Entry"."External Document No.", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
