report 50013 "General Journal - Test - YNA"
{
    // =================================================================================
    // Ver.No.     Date         Sign.  ID              Description
    // ---------------------------------------------------------------------------------
    // CS1.0       2016-06-10   hcj  FDD212          "Modify General Journal - Test report (ID=2) to include AP/AR accounts as reconciliation accounts
    // =================================================================================
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/General Journal - Test.rdlc';

    Caption = 'General Journal - Test - YNA';
    ...
    dataset
    {
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(DocNoCaption_GenJnlLine; DocumentNoCap)
                {
                }
                ...
                column(BalAccNoCaption_GenJnlLine; BalAccNoCap)
                {
                }
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    begin
                        ...
                        IF NOT EmptyLine THEN BEGIN
                            ...
                            // FDD212 begin
                            IF ("AP/AR Account No." <> '') AND ("Account Type" <> "Account Type"::"G/L Account") THEN BEGIN
                                GLAcc2.GET("AP/AR Account No.");
                                IF GLAcc2."Reconciliation Account" THEN
                                    ReconcileGLAccNo("AP/AR Account No.", ROUND("Amount (LCY)" / (1 + "VAT %" / 100)));
                            END;
                            //FDD212 end. 2016-06-10 hcj
    ...
    var
        ...
        DocumentTypeCap: Label 'Doc. Type';
        AccountTypeCap: Label 'Acc. Type';
        ...
        DocumentNoCap: Label 'Doc. No.';
        BalAccNoCap: Label 'Bal. Acc. No.';
...
THEN BEGIN
            IF GenJnlTemplate."Force Doc. Balance" THEN BEGIN
                CASE TRUE OF
                    ...
                    DocBalanceReverse <> 0:
                        AddError(
                          STRSUBSTNO(
                            Text026, LastDocType, LastDocNo, DocBalanceReverse));
                END;
                DocBalanceReverse := 0;
            END;
    ...
    begin
        ...
        ELSE BEGIN
            ...
            IF GLAcc."Reconciliation Account" THEN BEGIN
