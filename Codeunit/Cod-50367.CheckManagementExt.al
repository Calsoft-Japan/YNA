...
codeunit 50367 CheckManagementExt
{
    ...
    begin
        ...
        VendLedgEntry.GET(PayDetailedVendorLedgEntry."Vendor Ledger Entry No.");
        //fdd210 end;
        ...
        IF PayDetailedVendorLedgEntry."Document Type" = PayDetailedVendorLedgEntry."Document Type"::Payment THEN BEGIN
            DetailVLE.RESET;
            DetailVLE.SETRANGE("Entry No.", PayDetailedVendorLedgEntry."Entry No.");
            IF DetailVLE.FIND('-') THEN BEGIN
                ...
                IF PayDetailedVendorLedgEntry."Transaction No." = 0 THEN BEGIN
                    DetailVLE.SETCURRENTKEY("Application No.", "Vendor No.", "Entry Type");
                    DetailVLE.SETRANGE("Application No.", PayDetailedVendorLedgEntry."Application No.");
                END ELSE BEGIN
                    DetailVLE.SETCURRENTKEY("Transaction No.", "Vendor No.", "Entry Type");
                    DetailVLE.SETRANGE("Transaction No.", PayDetailedVendorLedgEntry."Transaction No.");
                END;
